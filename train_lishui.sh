...
./darknet detector train data/lishui_0914/trafficlights2.data cfg/lishui_0914/yolov3-giou.cfg darknet53.conv.74 -mAP -gpus 2,3 -dont_show

./darknet detector train data/lishui_0927/trafficlights2.data cfg/lishui_0927/yolov3-giou.cfg darknet53.conv.74 -mAP -gpus 2,3 -dont_show
